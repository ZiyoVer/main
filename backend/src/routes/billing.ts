...
function postPaylovTokenGrant(grant: PaylovTokenGrant): Promise<PaylovHttpResponse> {
    ...
    const requestBody = Buffer.from(serializePaylovTokenGrant(grant), 'utf8')
 ...
 * duplicate tranzaksiya ochilishi mumkin. Faqat aniq 401/403 javobida access
 * token bir marta yangilanadi — autentifikatsiyadan o'tmagan so'rov pul
 * yaratmagan bo'ladi.
 */
function postPaylov(
