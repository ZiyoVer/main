...
| 2026-07-25 | `student-workspace` ink focus-visible qoidasi composer textareasidan chiqarildi; textarea fokusi box’ning orange focus-within ring’i bilan ko‘rinadi | Textareadagi 2px qora outline + box orange ring’i double-border hosil qilardi; keyboard a11y saqlangan |
